...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins Shell/pcie_root_complex/cdma_interconnect/M00_AXI] [get_bd_intf_pins Shell/pcie_root_complex/cdma_dma]
...
connect_bd_intf_net [get_bd_intf_pins Shell/pcie_root_complex/xdma_0/M_AXI_B] -boundary_type upper [get_bd_intf_pins Shell/pcie_root_complex/pcie_dma]
...
connect_bd_net [get_bd_pins Shell/pcie_root_complex/xdma_0/axi_aclk] [get_bd_pins Shell/pcie_root_complex/clk_pcie]
...
connect_bd_net [get_bd_pins Shell/pcie_root_complex/xdma_0/axi_aresetn] [get_bd_pins Shell/pcie_root_complex/reset_pcie]

connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/PCIe_Hub/S00_ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/PCIe_Hub/S01_ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/S00_ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/M00_ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/M01_ACLK]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/clk_200mhz] [get_bd_pins Shell/pcie_root_complex/axi_cdma_0/m_axi_aclk]
...
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/PCIe_Hub/S00_ARESETN]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/PCIe_Hub/S01_ARESETN]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/ARESETN]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/S00_ARESETN]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/M00_ARESETN]
connect_bd_net [get_bd_pins Shell/pcie_root_complex/reset_200mhz] [get_bd_pins Shell/pcie_root_complex/cdma_interconnect/M01_ARESETN]
