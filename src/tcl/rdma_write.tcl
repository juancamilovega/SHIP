...
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/packet_length_counter/aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/write_signal_handler/aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/write_organizer/aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/data_storer/aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/verifier/aclk]

connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/packet_length_counter/aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/write_signal_handler/aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/write_organizer/aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/data_storer/aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/verifier/aresetn]

connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/length_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/request_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/data_in_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/instructions_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/mem_transfer_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/done_fifo/s_axis_aclk]
connect_bd_net [get_bd_pins write_sector/clk_266mhz] [get_bd_pins write_sector/ack_fifo/s_axis_aclk]

connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/length_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/request_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/data_in_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/instructions_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/mem_transfer_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/done_fifo/s_axis_aresetn]
connect_bd_net [get_bd_pins write_sector/reset_266mhz] [get_bd_pins write_sector/ack_fifo/s_axis_aresetn]
